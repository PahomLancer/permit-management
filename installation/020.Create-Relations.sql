declare
    ...
    v_permit_ttid xitor_type.xitor_type_id%type;
...
begin
    ...
    select xitor_type_id into v_permit_ttid from xitor_type where xitor_type = 'Permit' and program_id = v_program_id;
    ...
    v_rtid3 := pkg_relation.new_relation_type(null, v_permit_ttid, c_rel_cardinality_one_many, 0, 0);
    v_rtid4 := pkg_relation.new_relation_type(v_jurisdiction_ttid, v_permit_ttid, c_rel_cardinality_one_many, 0, 0);
    v_rtid5 := pkg_relation.new_relation_type(v_project_ttid, v_permit_ttid, c_rel_cardinality_one_many, 1, 0);
